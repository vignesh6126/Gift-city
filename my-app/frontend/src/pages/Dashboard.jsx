...
.logout-card{margin:8px 0 16px;padding:6px;border-radius:12px;border:1px solid rgba(79,142,247,0.25);background:rgba(79,142,247,0.05);transition:transform .28s var(--spring),box-shadow .28s}
